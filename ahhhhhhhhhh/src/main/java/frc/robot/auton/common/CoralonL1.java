...
public class CoralonL1 extends SequentialCommandGroup {

    public CoralonL1 (SwerveDrivetrain drivetrain, elevator elevator,RobotContainer container, CoralWrist coralWrist, Coral coral) {

        addCommands(  
          new SequentialCommandGroup(

                new MoveInReverse(drivetrain, container,.5).withTimeout(1.2),
