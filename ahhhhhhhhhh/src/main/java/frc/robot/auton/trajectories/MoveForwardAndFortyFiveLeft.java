...
public class MoveForwardAndFortyFiveLeft extends SequentialCommandGroup {

	private double forwardDistance;
	private double leftDistance;
	//private double finalHeading;

	public MoveForwardAndFortyFiveLeft(SwerveDrivetrain drivetrain, RobotContainer container, double forwardDistance, double leftDistance, double finalHeading) {
	...
	public Trajectory createForwardAndLeftTrajectory(RobotContainer container) {
		...
		Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
			...
			new Pose2d(+forwardDistance, +leftDistance, Rotation2d.fromDegrees(45)),
