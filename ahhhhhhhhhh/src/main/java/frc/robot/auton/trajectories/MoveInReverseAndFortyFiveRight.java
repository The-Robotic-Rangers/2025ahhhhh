...
public class MoveInReverseAndFortyFiveRight extends SequentialCommandGroup {

	private double reverseDistance;
	private double rightDistance;

	public MoveInReverseAndFortyFiveRight(SwerveDrivetrain drivetrain, RobotContainer container,  double reverseDistance, double rightDistance) {
	...
	public Trajectory createReverseAndHardRightTrajectory(RobotContainer container) {
		...
		Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
			...
			new Pose2d(+reverseDistance, +rightDistance, Rotation2d.fromDegrees(-45)),
