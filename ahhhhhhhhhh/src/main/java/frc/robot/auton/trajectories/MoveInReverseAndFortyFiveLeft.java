...
public class MoveInReverseAndFortyFiveLeft extends SequentialCommandGroup {

	private double reverseDistance;
	private double leftDistance;

	public MoveInReverseAndFortyFiveLeft(SwerveDrivetrain drivetrain, RobotContainer container,  double reverseDistance, double leftDistance) {
	...
	public Trajectory createReverseAndHardRightTrajectory(RobotContainer container) {
		...
		Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
			...
			new Pose2d(+reverseDistance, -leftDistance, Rotation2d.fromDegrees(+45)),
