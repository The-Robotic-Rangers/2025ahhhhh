...
public class MoveForwardAndFortyFiveRight extends SequentialCommandGroup {

	private double forwardDistance;
	private double rightDistance;
	//private double finalHeading;

	public MoveForwardAndFortyFiveRight(SwerveDrivetrain drivetrain, RobotContainer container, double forwardDistance, double rightDistance, double finalHeading) {
	...
	public Trajectory createForwardAndRightTrajectory(RobotContainer container) {
		...
		Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
			...
			new Pose2d(+forwardDistance, -rightDistance, Rotation2d.fromDegrees(-45)),
